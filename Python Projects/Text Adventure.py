...
def lose_tug_of_war():
    slow_print(bold + "\nYou Lose\nBad team or bad choice, either one you must face the punishment.\n" + reset_bold,text_length)
...
def fourth_start():
    ...
    while marbles < 20 and marbles > 0:
        ...
        if player_set == 'player_1' and marbles > 0 and marbles < 20:
            ...
            choice = input("Choose a number of marbles(integer only): ")
            while not choice.isdigit():
                choice = input("Try to enter an integer: ")
            choice = int(choice)
...
def marble_loss():
    slow_print(bold + "You lose\nUnfortunately, you lost after having 0 marbles in your hand and now you must be punished.\n" + reset_bold, text_length)
    home()
...
def fifth_game():
    slow_print(bold + "Welcome to the fifth game contestants. You will be playing Glass Stepping Stones. This is a game that involves choosing the right place to step.\
 ...
 choose either left or right. Make it to the end within the 25s time limit or you lose.\n" + reset_bold, text_length)
    ...
    for i in range(5):
        ...
        random_direction = random.choice(left_right)
...
def sixth_game_part_1():
    ...
    if option == '1':
        ...
        slow_print(bold + "You lose\nThe knife throw is uneffective and after receiving a minor cut, he now has two knives and you have none.\
 He then stabs you with both, leaving you with no options. You made it so far, however this is as far as you go.\n" + reset_bold, text_length)
        input("Press enter to restart: ")
        home()
...
def sixth_game_part_2():
    ...
    if option == '1':
        ...
        slow_print(bold + "You lose\nAs soon as you take the knife out, you feel immense pain and your attacks now become very weak. He counter\
 attacks with a hard hit to your throat and then throws you out of the arena. You made it so far, however this is as far as you go.\n" + reset_bold, text_length)
        input("Press Enter to Restart: ")
        home()
...
def sixth_game_part_3():
    ...
    while not (option == '1' or option == '2'):
        option = input("Invalid Answer. Enter your choice again(1 or 2): ")
    if option == '1':
        slow_print(bold + "You lose\nHe takes the kick and is in pain, however he uses the rest of his strength to swing wide and hit the side of your skull.\
 You fall down and cannot continue. The guards then shoot you. You made it so far, however this is as far as you go.\n" + reset_bold, text_length)
        input("Press Enter to Restart: ")
        home()
    elif option == '2':
...
def win_squid_game():
    slow_print(bold + "Congratulations! After going through 6 of our games, you rise on top and is now the last one standing.\
