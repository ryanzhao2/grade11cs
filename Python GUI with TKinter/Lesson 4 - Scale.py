...
mainframe.grid(row=2, column=1, padx=30, pady=40)

titleLabel.grid(row=1, column=0, padx=20, sticky=W)

tempLabel.grid(row=3, column=0, padx=10, sticky=NW)
tempScale.grid(row=2, column=0, pady=20, sticky=W)

windLabel.grid(row=3, column=0, padx=50, sticky=NW)
speedScale.grid(row=2, column=0, padx=40, pady=20, sticky=W)

feelLikeLabel.grid(row=2, column=0, padx=100)
...
serviceLevelLabel = Label(mainframe, font=("Arial 20"), textvariable=serviceLevelVar)
...
serviceLevelLabel.grid(row=1, column=2, sticky=E)
serviceScale.grid(row=2, column=1, columnspan=2, ipadx=50)
